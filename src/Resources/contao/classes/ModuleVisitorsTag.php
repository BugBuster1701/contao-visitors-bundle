...
class ModuleVisitorsTag extends Frontend
{
			...
			case "bestday":
				...
				switch ($arrTag[3])
				{
					case "date":
						...
						if (!isset($arrTag[4]))
						{
							return date(Config::get('dateFormat'), strtotime($objVisitorsBestday->visitors_date));
						}
	...
	protected function visitorGetPageType($objPage)
	{
		...
		if ($objPage->protected == 1)
		{
			...
			if (false === System::getContainer()->get('contao.security.token_checker')->hasFrontendUser())
			{
