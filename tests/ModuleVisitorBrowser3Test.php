...
class ModuleVisitorBrowser3Test extends TestCase
{
    ...
    public function providerAgents()
    {
        return array(//result,host
            array('Aloha Browser', 'Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-G975U1 Build/NMF26F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.96 Mobile Safari/537.36 AlohaBrowser/3.1.1'),
            array('Aloha Browser', 'Mozilla/5.0 (iPad; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Version/15.0 Safari/605.1.15 AlohaBrowser/3.2.6'),
            ...
            array('Edge',           'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/116 Version/13.0.3 Safari/605.1.15'),
    ...
    public function providerAgentPlatforms()
    {
        return array(//result,host
            ...
            array('Apple',    'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/116 Version/13.0.3 Safari/605.1.15')
        );
    }
    ...
    public function providerAgentVersions()
    {
        return array(//result,host
            ...
            array('0.07', 'Dooble/0.07 (de_DE) WebKit'),
            ...
            // alter Edge, gemapped
            array('42.17134', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/64.0.3282.140 Safari/537.36 Edge/17.17134'),
            // neuere Edges, nur Major Version wegen Abwärtskompatibilität
            array('74',   'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.48 Safari/537.36 Edg/74.1.96.24'),
            array('41',   'Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_2 like Mac OS X) AppleWebKit/603.2.4(KHTML, like Gecko) Mobile/14F89 Safari/603.2.4 EdgiOS/41'),
            array('41',   'Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_2 like Mac OS X) AppleWebKit/603.2.4(KHTML, like Gecko) Mobile/14F89 Safari/603.2.4 EdgiOS/41.1.35.1'),
            array('116',  'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/116 Version/13.0.3 Safari/605.1.15'),
            array('116',  'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_6) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/116.12 Version/13.0.3 Safari/605.1.15'),
            array('41',   'Mozilla/5.0 (Linux; Android 8.0; Pixel XL Build/OPP3.170518.006) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.0 Mobile Safari/537.36 EdgA/41'),
